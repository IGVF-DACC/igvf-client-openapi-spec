...
def test_generator_test_generate():
    ...
    expected_keys = ['/{resource_id}', '/search', '/profiles', '/profiles/{item_type}', '/multireport.tsv', '/{file_id}/@@download', '/batch-download', '/access-keys/@@listing', '/analysis-steps/@@listing', '/analysis-step-versions/@@listing', '/awards/@@listing', '/biomarkers/@@listing', '/documents/@@listing', '/human-donors/@@listing', '/rodent-donors/@@listing', '/alignment-files/@@listing', '/configuration-files/@@listing', '/image-files/@@listing', '/index-files/@@listing', '/matrix-files/@@listing', '/model-files/@@listing', '/reference-files/@@listing', '/sequence-files/@@listing', '/signal-files/@@listing', '/tabular-files/@@listing', '/analysis-sets/@@listing', '/auxiliary-sets/@@listing', '/construct-library-sets/@@listing', '/curated-sets/@@listing', '/measurement-sets/@@listing', '/model-sets/@@listing', '/prediction-sets/@@listing', '/genes/@@listing', '/images/@@listing', '/institutional-certificates/@@listing', '/labs/@@listing', '/crispr-modifications/@@listing', '/degron-modifications/@@listing', '/assay-terms/@@listing', '/phenotype-terms/@@listing', '/platform-terms/@@listing', '/sample-terms/@@listing', '/open-reading-frames/@@listing', '/pages/@@listing', '/phenotypic-features/@@listing', '/publications/@@listing', '/mpra-quality-metrics/@@listing', '/perturb-seq-quality-metrics/@@listing', '/single-cell-atac-seq-quality-metrics/@@listing', '/single-cell-rna-seq-quality-metrics/@@listing', '/starr-seq-quality-metrics/@@listing', '/in-vitro-systems/@@listing', '/multiplexed-samples/@@listing', '/primary-cells/@@listing', '/technical-samples/@@listing', '/tissues/@@listing', '/whole-organisms/@@listing', '/software/@@listing', '/software-versions/@@listing', '/sources/@@listing', '/treatments/@@listing', '/users/@@listing', '/workflows/@@listing']
    ...
    assert set(expected_keys) == set(actual_keys), actual_keys
    expected_keys = ['query', 'frame', 'limit', 'sort', '@id', 'accession', 'aliases', 'alternate_accessions', 'assay_term.@id', 'assay_term.assay_slims', 'assay_term.status', 'assay_term.term_name', 'assay_titles', 'auxiliary_sets.@id', 'auxiliary_sets.accession', 'auxiliary_sets.aliases', 'auxiliary_sets.file_set_type', 'auxiliary_sets.status', 'award.@id', 'award.component', 'award.contact_pi.@id', 'award.contact_pi.title', 'award.title', 'barcode_replacement_file', 'collections', 'construct_library_sets.@id', 'construct_library_sets.accession', 'construct_library_sets.file_set_type', 'construct_library_sets.integrated_content_files.@id', 'construct_library_sets.integrated_content_files.accession', 'construct_library_sets.integrated_content_files.status', 'construct_library_sets.selection_criteria', 'construct_library_sets.small_scale_gene_list.@id', 'construct_library_sets.small_scale_gene_list.geneid', 'construct_library_sets.small_scale_gene_list.name', 'construct_library_sets.small_scale_gene_list.status', 'construct_library_sets.small_scale_gene_list.summary', 'construct_library_sets.small_scale_gene_list.symbol', 'construct_library_sets.status', 'construct_library_sets.summary', 'control_file_sets.@id', 'control_file_sets.accession', 'control_file_sets.aliases', 'control_file_sets.status', 'control_for.@id', 'control_for.accession', 'control_for.aliases', 'control_for.status', 'control_types', 'controlled_access', 'creation_timestamp', 'data_use_limitation_summaries', 'dbxrefs', 'description', 'documents', 'donors.@id', 'donors.accession', 'donors.aliases', 'donors.sex', 'donors.status', 'donors.strain_background', 'donors.taxa', 'external_image_urls', 'externally_hosted', 'file_set_type', 'files.@id', 'files.accession', 'files.aliases', 'files.anvil_url', 'files.assembly', 'files.cell_type_annotation.@id', 'files.cell_type_annotation.term_name', 'files.content_type', 'files.controlled_access', 'files.creation_timestamp', 'files.derived_from', 'files.file_format', 'files.file_format_type', 'files.file_size', 'files.flowcell_id', 'files.href', 'files.illumina_read_type', 'files.lane', 'files.md5sum', 'files.mean_read_length', 'files.s3_uri', 'files.seqspec_document', 'files.seqspecs', 'files.sequencing_kit', 'files.sequencing_platform.@id', 'files.sequencing_platform.status', 'files.sequencing_platform.term_name', 'files.sequencing_run', 'files.status', 'files.submitted_file_name', 'files.summary', 'files.transcriptome_annotation', 'files.upload_status', 'files.workflows.@id', 'files.workflows.accession', 'functional_assay_mechanisms.@id', 'functional_assay_mechanisms.status', 'functional_assay_mechanisms.term_id', 'functional_assay_mechanisms.term_name', 'input_for.@id', 'input_for.accession', 'input_for.aliases', 'input_for.status', 'input_for.uniform_pipeline_status', 'lab.@id', 'lab.title', 'multiome_size', 'notes', 'onlist_files', 'onlist_method', 'preferred_assay_titles', 'preview_timestamp', 'primer_designs', 'protocols', 'publications.@id', 'publications.publication_identifiers', 'publications.status', 'related_multiome_datasets.@id', 'related_multiome_datasets.accession', 'related_multiome_datasets.status', 'release_timestamp', 'revoke_detail', 'samples.@id', 'samples.accession', 'samples.aliases', 'samples.cellular_sub_pool', 'samples.classifications', 'samples.disease_terms.@id', 'samples.disease_terms.status', 'samples.disease_terms.term_name', 'samples.growth_medium', 'samples.institutional_certificates.@id', 'samples.institutional_certificates.certificate_identifier', 'samples.institutional_certificates.controlled_access', 'samples.institutional_certificates.data_use_limitation', 'samples.institutional_certificates.data_use_limitation_modifiers', 'samples.institutional_certificates.status', 'samples.modifications.@id', 'samples.modifications.modality', 'samples.modifications.status', 'samples.sample_terms.@id', 'samples.sample_terms.aliases', 'samples.sample_terms.status', 'samples.sample_terms.summary', 'samples.sample_terms.term_name', 'samples.status', 'samples.summary', 'samples.targeted_sample_term.@id', 'samples.targeted_sample_term.status', 'samples.targeted_sample_term.term_name', 'samples.taxa', 'samples.treatments.@id', 'samples.treatments.purpose', 'samples.treatments.status', 'samples.treatments.summary', 'samples.treatments.treatment_term_name', 'samples.treatments.treatment_type', 'sequencing_library_types', 'status', 'strand_specificity', 'submitted_by.@id', 'submitted_by.title', 'submitted_files_timestamp', 'submitter_comment', 'summary', 'targeted_genes.@id', 'targeted_genes.geneid', 'targeted_genes.name', 'targeted_genes.status', 'targeted_genes.symbol', 'targeted_genes.synonyms', 'uuid']
    actual_keys = [x['name'] for x in openapi_spec['paths']['/measurement-sets/@@listing']['get']['parameters']]
    assert set(expected_keys) == set(actual_keys), list(actual_keys)
    ...
    expected = {
        '/sequence-files/@@listing': {
            'get': {
                ...
                'responses': {
                    '200': {'description': 'Successful response', 'content': {'application/json': {'schema': {'type': 'object', 'title': 'SequenceFileResults', 'properties': {'@graph': {'type': 'array', 'items': {'$ref': '#/components/schemas/SequenceFile'}}, '@id': {'type': 'string'}, '@type': {'type': 'array', 'items': {'type': 'string'}}, 'total': {'type': 'integer'}, 'facets': {'type': 'array', 'items': {'type': 'object', 'title': 'SearchFacet', 'properties': {'field': {'type': 'string'}, 'title': {'type': 'string'}, 'total': {'type': 'integer'}, 'type': {'type': 'string'}, 'terms': {}}}}}}}}}, '400': {'description': 'Bad request', 'content': {'application/json': {'schema': {'type': 'object'}}}},
