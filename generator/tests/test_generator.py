...
def test_generator_test_generate():
    ...
    assert set(expected_keys) == set(actual_keys)
    expected_keys = ['query', 'frame', 'limit', 'sort', '@id', 'accession', 'aliases', 'alternate_accessions', 'assay_term.@id', 'assay_term.term_name', 'auxiliary_sets.@id', 'auxiliary_sets.accession', 'auxiliary_sets.aliases', 'auxiliary_sets.file_set_type', 'award.@id', 'award.component', 'award.contact_pi.@id', 'award.contact_pi.title', 'award.title', 'collections', 'control_file_sets.@id', 'control_file_sets.accession', 'control_file_sets.aliases', 'control_for.@id', 'control_for.accession', 'control_for.aliases', 'control_type', 'creation_timestamp', 'dbxrefs', 'description', 'documents', 'donors.@id', 'donors.accession', 'donors.aliases', 'donors.sex', 'donors.status', 'donors.taxa', 'external_image_url', 'externally_hosted', 'file_set_type', 'files.@id', 'files.accession', 'files.aliases', 'files.assembly', 'files.content_type', 'files.creation_timestamp', 'files.file_format', 'files.file_size', 'files.href', 'files.s3_uri', 'files.sequencing_platform.@id', 'files.sequencing_platform.term_name', 'files.submitted_file_name', 'files.transcriptome_annotation', 'files.upload_status', 'functional_assay_mechanisms.@id', 'functional_assay_mechanisms.term_id', 'functional_assay_mechanisms.term_name', 'input_for', 'lab.@id', 'lab.title', 'multiome_size', 'notes', 'preferred_assay_title', 'protocols', 'publications.@id', 'publications.publication_identifiers', 'related_multiome_datasets.@id', 'related_multiome_datasets.accession', 'release_timestamp', 'revoke_detail', 'samples.@id', 'samples.accession', 'samples.aliases', 'samples.cell_fate_change_treatments.@id', 'samples.cell_fate_change_treatments.purpose', 'samples.cell_fate_change_treatments.summary', 'samples.cell_fate_change_treatments.treatment_type', 'samples.classifications', 'samples.construct_library_sets.@id', 'samples.construct_library_sets.accession', 'samples.construct_library_sets.file_set_type', 'samples.construct_library_sets.small_scale_gene_list.@id', 'samples.construct_library_sets.small_scale_gene_list.geneid', 'samples.construct_library_sets.small_scale_gene_list.name', 'samples.construct_library_sets.small_scale_gene_list.summary', 'samples.construct_library_sets.small_scale_gene_list.symbol', 'samples.construct_library_sets.summary', 'samples.disease_terms.@id', 'samples.disease_terms.term_name', 'samples.modifications.@id', 'samples.modifications.modality', 'samples.sample_terms.@id', 'samples.sample_terms.aliases', 'samples.sample_terms.status', 'samples.sample_terms.summary', 'samples.sample_terms.term_name', 'samples.status', 'samples.summary', 'samples.targeted_sample_term.@id', 'samples.targeted_sample_term.term_name', 'samples.taxa', 'samples.treatments.@id', 'samples.treatments.purpose', 'samples.treatments.summary', 'samples.treatments.treatment_term_name', 'samples.treatments.treatment_type', 'sequencing_library_types', 'status', 'submitted_by.@id', 'submitted_by.title', 'submitted_files_timestamp', 'submitter_comment', 'summary', 'targeted_genes.@id', 'targeted_genes.geneid', 'targeted_genes.name', 'targeted_genes.symbol', 'targeted_genes.synonyms', 'uuid']
