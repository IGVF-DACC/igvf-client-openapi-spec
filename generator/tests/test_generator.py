    ...
    expected = {
        '/sequence-files/@@listing': {
            'get': {
                ...
                'responses': {
                    '200': {'description': 'Successful response', 'content': {'application/json': {'schema': {'type': 'object', 'title': 'SequenceFileResults', 'properties': {'@graph': {'type': 'array', 'items': {'$ref': '#/components/schemas/SequenceFile'}}, '@id': {'type': 'string'}, '@type': {'type': 'array', 'items': {'type': 'string'}}, 'total': {'type': 'integer'}, 'facets': {'type': 'array', 'items': {'type': 'object', 'title': 'SearchFacet', 'properties': {'field': {'type': 'string'}, 'title': {'type': 'string'}, 'total': {'type': 'integer'}, 'type': {'type': 'string'}, 'terms': {'type': 'array', 'items': {'title': 'SearchFacetTermValue', 'type': 'object'}}}}}}}}}}, '400': {'description': 'Bad request', 'content': {'application/json': {'schema': {'type': 'object'}}}},
